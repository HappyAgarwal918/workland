...
<aside class="sidebar" id="sidebar">
  ...
  <ul class="menu">
    <li><span>Request</span>
      <ul>
        <li><a href="{{ route('guide.manage-request') }}">Manage Request</a></li>
        <li><a href="{{ route('guide.message') }}">Message</a></li>
      </ul>
    </li>
    <li><span>Tour</span>
      <ul>
        <li><a href="{{ route('guide.upcoming-tour-request') }}">Upcoming Tour</a></li>
        <li><a href="{{ route('guide.outgoing-tour-request') }}">Outgoing Tour</a></li>
      </ul>
    </li>
    <li><span>Settings</span>
      <ul>
        <li><a href="{{ route('guide.my-profile') }}">Profile</a></li>
      </ul>
    </li>
  </ul>
