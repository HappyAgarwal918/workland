...
@section('title', 'Workland - Login as Guide')

@section('content')

<section class="bg-sign-up">
  <div class="container">
    <h1>Sign in as Guide</h1>
    <div class="signup-inner">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="from-control input-icon">
              ...
              <input type="password" name="password" placeholder="Enter Your Password" id="gPwd">
              <img src="{{ asset('assets/img/pasword-vision.png') }}" class="input-pos-icon" id="toggleGPwd" style="cursor:pointer">
            </div>
          </div>
      ...
      <div class="sign-other-way">
        <p>I don't have an account. <a href="{{ route('guide.register') }}">Signup as Guide</a></p>
        <p>or Sign in with</p>
...
@section('scripts')
<script>
  document.getElementById('toggleGPwd').addEventListener('click', function () {
    const pwd = document.getElementById('gPwd');
