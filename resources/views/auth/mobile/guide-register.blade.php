...
<head>
  ...
  <title>Workland - Signup as Guide</title>
...
<div class="login-card text-center">
  ...
  <h5 class="mb-4 fw-semibold">Sign up as Guide</h5>
  ...
  <form method="POST" action="{{ route('register') }}">
    ...
    <div class="mb-3 text-start position-relative">
      ...
      <div class="input-group1 position-relative">
        <input type="password" name="password" class="form-control" id="gPwd1" placeholder="Enter Your Password">
        <button class="btn-outline-secondary1" type="button" id="toggleGPwd1"><i class="bi bi-eye"></i></button>
      </div>
    ...
    <div class="mb-3 text-start position-relative">
      ...
      <div class="input-group1 position-relative">
        <input type="password" name="password_confirmation" class="form-control" id="gPwd2" placeholder="Confirm Your Password">
        <button class="btn-outline-secondary1" type="button" id="toggleGPwd2"><i class="bi bi-eye"></i></button>
      </div>
    </div>
    <button type="submit" class="btn-login">Sign Up</button>
    <p class="mt-4 mb-2 text-muted1">Already have an account? <a href="{{ route('guide.login') }}" class="signup-link">Login as Guide</a></p>
  </form>
</div>
...
<script>
  ['1','2'].forEach(n => {
    document.getElementById('toggleGPwd'+n).addEventListener('click', function () {
      const pwd = document.getElementById('gPwd'+n);
