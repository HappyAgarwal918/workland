...
<head>
  ...
  <title>Workland - Login as Guide</title>
...
<div class="login-card text-center">
  ...
  <h5 class="mb-4 fw-semibold">Log in as Guide</h5>
  ...
  <form method="POST" action="{{ route('login') }}">
    ...
    <div class="mb-3 text-start position-relative">
      ...
      <div class="input-group1 position-relative">
        <input type="password" name="password" class="form-control" id="gPasswordInput" placeholder="Enter Your Password">
        <button class="btn-outline-secondary1" type="button" id="toggleGPassword">
          <i class="bi bi-eye"></i>
        </button>
      </div>
    </div>
    ...
    <p class="mt-4 mb-2 text-muted1">I haven't got an account? <a href="{{ route('guide.register') }}" class="signup-link">Signup as Guide</a></p>
    <p>or</p>
...
<script>
  document.getElementById('toggleGPassword').addEventListener('click', function () {
