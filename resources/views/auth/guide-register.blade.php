...
@section('title', 'Workland - Sign Up as Guide')

@section('content')

<section class="bg-sign-up">
  <div class="container">
    <h1>Sign up as Guide</h1>
    <div class="signup-inner">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="from-control input-icon">
              ...
              <input type="password" name="password" placeholder="Enter Your Password" id="gPwd1">
              <img src="{{ asset('assets/img/pasword-vision.png') }}" class="input-pos-icon" id="toggleGPwd1" style="cursor:pointer">
          ...
          <div class="col-lg-12">
            <div class="from-control input-icon">
              ...
              <input type="password" name="password_confirmation" placeholder="Enter Your Confirm Password" id="gPwd2">
              <img src="{{ asset('assets/img/pasword-vision.png') }}" class="input-pos-icon" id="toggleGPwd2" style="cursor:pointer">
            </div>
          </div>
      ...
      <div class="sign-other-way">
        <p>I already have an account. <a href="{{ route('guide.login') }}">Signin as Guide</a></p>
        <p>or Sign in with</p>
