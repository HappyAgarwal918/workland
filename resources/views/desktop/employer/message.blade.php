    ...
    <div class="col-md-4 border-end">
      ...
      <div class="chat-list">
        ...
        <div class="chat-item d-flex align-items-center p-3 border-bottom @if($i===1) active bg-light @endif" style="cursor:pointer;">
          ...
          <div>
            <h6 class="mb-0">Mahima Goyal</h6>
            <small class="text-muted">Hey, are you available on...</small>
          </div>
        </div>
        @endfor
      </div>
    ...
    <div class="col-md-8 d-flex flex-column">
      ...
      <div class="flex-grow-1 p-3 overflow-auto" style="background:#f8f9fa;">
        <div class="mb-3 text-end">
          <div class="d-inline-block bg-primary text-white rounded p-2" style="max-width:70%;">Hello! I'm interested in your tour guide services.</div>
        </div>
        <div class="mb-3">
          <div class="d-inline-block bg-white rounded p-2 border" style="max-width:70%;">Hi! I'd be happy to help. When are you looking for a guide?</div>
        </div>
        <div class="mb-3 text-end">
          <div class="d-inline-block bg-primary text-white rounded p-2" style="max-width:70%;">We need a guide for August 12-16, 2025.</div>
        </div>
      </div>
